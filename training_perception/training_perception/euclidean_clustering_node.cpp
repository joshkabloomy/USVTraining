...
#include "training_msgs/msg/bounding_box.hpp"
#include "training_msgs/msg/bounding_box_array.hpp"
...
class EuclideanClusteringNode : public rclcpp::Node {
    ...
    void points_callback(const sensor_msgs::msg::PointCloud2& msg) const {
        ...
        training_msgs::msg::BoundingBoxArray boxes;
        ...
        for (const auto& cluster : cluster_indices) {
            ...
            training_msgs::msg::BoundingBox box;
    ...
    void add_centroid_to_bounding_box(training_msgs::msg::BoundingBox& box, 
    ...
    void add_point_to_bounding_box_corners(training_msgs::msg::BoundingBox& box,
    ...
    rclcpp::Publisher<training_msgs::msg::BoundingBoxArray>::SharedPtr m_boxes_pub;
    ...
    public:
        EuclideanClusteringNode() : Node("perception_euclidean_clustering") {
            ...
            m_points_sub = this->create_subscription<sensor_msgs::msg::PointCloud2>(
                "/perception/lidar/points_filtered", 10, std::bind(&EuclideanClusteringNode::points_callback, this, std::placeholders::_1)
            );
            m_clusters_viz_pub = this->create_publisher<visualization_msgs::msg::MarkerArray>(
                "/perception/clusters_viz", 10
            );
            m_boxes_pub = this->create_publisher<training_msgs::msg::BoundingBoxArray>(
